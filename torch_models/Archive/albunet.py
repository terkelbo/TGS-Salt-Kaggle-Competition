...
class AlbuNet(nn.Module):
    ...
    def forward(self, x):
        ...
        conv2 = self.drop(self.conv2(conv1))
        conv3 = self.drop(self.conv3(conv2))
        conv4 = self.drop(self.conv4(conv3))
        conv5 = self.drop(self.conv5(conv4))

        center = self.drop(self.center(self.pool(conv5)))
        ...
        dec1 = self.drop(self.dec1(dec2))
        dec0 = self.drop(self.dec0(dec1))
