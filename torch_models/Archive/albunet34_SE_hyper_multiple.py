# -*- coding: utf-8 -*-
"""
Created on Sat Oct  6 13:50:51 2018
...
class AlbuNet(nn.Module):
    ...
    def __init__(self, num_classes=1, num_filters=32, pretrained=False, is_deconv=True):
        ...
        self.final = nn.Conv2d(1280, num_classes, kernel_size=1)
    ...
    def forward(self, x):
        ...
        image_pool = F.adaptive_avg_pool2d(conv5, 1)
        hyper_non_interpolated = [dec0, dec1, dec2, dec3, dec4, dec5]
        ...
        cat = torch.cat([
                    ...
                    F.interpolate(image_pool, scale_factor = 128, mode='nearest')
                ],1)
    


        return self.final(cat), image_pool, hyper_non_interpolated
