# -*- coding: utf-8 -*-
"""
Created on Sun Aug  5 13:43:20 2018
...
class VGG11_UNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.up_conv1 = up_conv(768, 256)
        self.up_conv2 = up_conv(384, 128)
        self.up_conv3 = up_conv(192, 64)
        self.up_conv4 = up_conv(128, 32)
...
def get_model(n_channels, n_classes):
    model = VGG11_UNet(n_channels, n_classes)
